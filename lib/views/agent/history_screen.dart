    ...
    return ListView(
      children: productGroups.entries.map((entry) {
        ...
        return ExpansionTile(
          ...
          subtitle: Text('${data.totalQuantity} items - Total: ${data.totalAmount.toStringAsFixed(2)} TND'),
          children: [
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Unit price: ${data.product.price.toStringAsFixed(2)} TND'),
                  ...
                  ...data.sales.take(3).map((sale) {
                    ...
                    return ListTile(
                      ...
                      trailing: Text('$quantityInSale × ${data.product.price.toStringAsFixed(2)} TND'),
                    );
                  }).toList(),
                ...
                children: [
                  ...
                  ...data.sales.take(3).map((sale) {
                    return ListTile(
                      ...
                      title: Text('Sale #${sale.id.substring(0, 6)}'),
                      subtitle: Text(DateFormat('MMM dd, HH:mm').format(sale.date)),
                      trailing: Text('${sale.totalAmount.toStringAsFixed(2)} TND'),
                    );
                  }).toList(),
                ],
              ),
    ...
    return ListView(
      children: paymentGroups.entries.map((entry) {
        ...
        return ExpansionTile(
          ...
          subtitle: Text('${paymentSales.length} sales - Total: ${totalAmount.toStringAsFixed(2)} TND'),
